/* MPU9250_MS5637_t3 Basic Example Code
 ...
 SCL ----------------------- A5
 GND ---------------------- GND
 SCL -- 10k Pull-up resistor -- 3.3V
 SDA -- 10k Pull-up resistor -- 3.3V
...
NOTE FOR THE GROUP: 
The calibration code is taken from this address however is already modified for Arduino Mega instead of Teensy 3.1 
All display function in the original sketch that the athuor wrote is deleted. 
...
//==========================================================
//====== End of implementation of the custom function ====== 
//==========================================================
